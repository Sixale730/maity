-- Update handle_user_company_invitation to work with company ID instead of slug
CREATE OR REPLACE FUNCTION public.handle_user_company_invitation(user_auth_id uuid, user_email text, company_id uuid, invitation_source text DEFAULT NULL::text, force_assign boolean DEFAULT false)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
