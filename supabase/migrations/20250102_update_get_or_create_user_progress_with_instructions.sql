-- Update get_or_create_user_progress to include user_instructions field
...
RETURNS TABLE(
  ...
  user_instructions TEXT,  -- NEW FIELD
...
BEGIN
  ...
  SELECT
    ...
    vps.user_instructions,  -- NEW FIELD
...
COMMENT ON FUNCTION maity.get_or_create_user_progress IS 'Get or create user progress for a profile with complete scenario information including user instructions';
