-- Create function to get user's voice sessions history with all details
...
COMMENT ON FUNCTION maity.get_user_sessions_history IS 'Returns complete session history for a user with all related details';
