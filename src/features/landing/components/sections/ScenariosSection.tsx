...
import { SCENARIOS } from '../../constants/scenarios-data';
            ...
            {[
              ...
              <div key={i} className="flex items-center gap-4">
                ...
                <div className="text-center">
                  <div
                    className="w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-3 font-bold text-white text-lg"
        ...
        <FadeIn delay={500}>
          <div className="text-center mt-16">
            <p className="text-gray-400 text-sm mb-6">
              Cada escenario es personalizable. Crea los tuyos propios para tu industria y equipo.
            </p>
            <button
