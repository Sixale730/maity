...
export const BusinessHeroSection = ({ setView }: BusinessHeroSectionProps) => {
  return (
        ...
        <div className="z-10">
          <FadeIn delay={100}>
            ...
            <h1 className="text-5xl md:text-6xl font-bold leading-tight mb-8 tracking-tighter text-white">
              Impulsa la evolucion de tu equipo con <br />
              <span
                className="text-transparent bg-clip-text"
                style={{
                  backgroundImage: `linear-gradient(to right, ${LANDING_COLORS.maityBlue}, ${LANDING_COLORS.maityGreen})`,
                }}
              >
            ...
            <p className="text-xl text-gray-400 mb-8 leading-relaxed max-w-lg">
              Escala el coaching de soft skills sin carga operativa. Metricas reales de
              evolucion, privacidad Enterprise y ROI medible desde el primer mes.
            </p>
            ...
            <VideoCard
              ...
              description="Descubre como Maity transforma equipos completos"
              duration="1:30"
            ...
            <div className="relative bg-[#0A0A0A] border border-white/10 rounded-xl p-6 shadow-2xl backdrop-blur-md">
              ...
              <div className="grid grid-cols-2 gap-4 mb-4">
                <div className="bg-[#141414] p-4 rounded-lg border border-white/5">
                  <div className="text-xs text-gray-500 mb-1">Evolucion del Equipo</div>
                ...
                <div className="bg-[#141414] p-4 rounded-lg border border-white/5">
                  ...
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="font-bold text-white">Negociacion</span>
                  </div>
                  <div className="text-xs text-gray-400">
                    El departamento de ventas aumento su score promedio a 8.9/10
                  </div>
                </div>
              </div>
