      ...
      <div className="bg-[#111118] border border-[#1e1e2e] rounded-xl p-4">
        ...
        <div className="flex items-center gap-4 mt-2 text-sm">
          ...
          <span className="flex items-center gap-1 text-[#ff6b35]">
            <Flame className="w-4 h-4" /> {streakDays} {t('gamified.streak_days')}
          </span>
        </div>
      </div>
      ...
      <div className="bg-[#111118] border border-[#1e1e2e] rounded-xl p-4">
        ...
        <div className="flex items-end gap-6">
          <div className="text-center">
            <p className="text-[#a0a0b0] text-xs mb-1">{t('gamified.yesterday')}</p>
          ...
          <div className="text-center">
            <div className="flex items-center gap-1 mb-1">
              ...
              <p className="text-xs text-[#a0a0b0]">{t('gamified.today')}</p>
            </div>
