  ...
  return (
    <div className="max-w-[1500px] mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <Card className="p-5 bg-[#0F0F0F] border border-white/10 mb-6">
        ...
        {/* Trend Alerts (compact inline) */}
        <div className="border-t border-white/5 pt-3 space-y-2">
          {[
            { icon: '🏆', text: 'Claridad cruzó de zona roja a amarilla (+18 pts)', color: 'text-[#1bea9a]' },
            { icon: '📈', text: 'Mejora notable en Objetivo (+13 pts)', color: 'text-green-400' },
            { icon: '⚠️', text: 'Estructura estancada en zona roja (28→38)', color: 'text-yellow-400' },
            { icon: '📈', text: 'Muletillas bajando: 3.9 → 2.8/min (−28%)', color: 'text-green-400' },
          ].map((alert, i) => (
