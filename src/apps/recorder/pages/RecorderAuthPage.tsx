 ...
 * RecorderAuthPage
 *
 * Simplified authentication page for the Recorder App.
 * Supports OAuth (Google, Microsoft) and email/password login.
 */
...
export function RecorderAuthPage() {
  ...
  const handleOAuthLogin = async (provider: 'google' | 'azure') => {
    ...
    try {
      ...
      toast({
        title: 'Error',
        description: (e as Error)?.message ?? 'No se pudo conectar con el proveedor.',
        variant: 'destructive',
      });
      setLoading(false);
    }
      ...
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardTitle className="font-geist text-2xl">
            {isLogin ? 'Inicia sesión para grabar' : 'Crear Cuenta'}
          </CardTitle>
          <CardDescription className="font-inter">
            {isLogin
              ? 'Accede para grabar y analizar tus conversaciones'
              : 'Crea tu cuenta para comenzar a grabar'}
          </CardDescription>
        </CardHeader>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-background px-2 text-muted-foreground font-inter">o</span>
            </div>
          </div>
          ...
          <form onSubmit={handleEmailAuth} className="space-y-4">
            ...
            <Button
              type="submit"
              className="w-full font-inter bg-primary hover:bg-primary/90"
              disabled={loading}
            >
          ...
          <div className="text-center pt-2 border-t">
            <a
              ...
              className="text-sm text-muted-foreground hover:text-foreground font-inter"
            >
...
export default RecorderAuthPage;
