...
export const ProductInfoSection = () => {
  return (
    <section className="py-24 bg-[#0A0A0A] border-t border-white/5 relative overflow-hidden">
      <div className="absolute right-0 top-1/4 w-[500px] h-[500px] bg-pink-600/5 rounded-full blur-[100px]" />
            ...
            <div className="sticky top-32">
              ...
              <div className="prose prose-invert prose-lg text-gray-400">
                <p className="leading-relaxed">
                  ...
                  <span className="text-white font-medium">
                    coach de soft skills impulsado por IA
                  </span>{' '}
                  que transforma conversaciones reales en entrenamiento medible y gamificado.
                </p>
                <p className="leading-relaxed mt-4">
                  A diferencia de herramientas que solo graban y resumen, Maity{' '}
                  <span className="text-white font-medium">entrena activamente</span> habilidades de
                  comunicación, venta, liderazgo y servicio, convirtiendo cada interacción en una
              ...
              <div className="mt-8 p-6 bg-[#0F0F0F] rounded-2xl border border-white/10 flex items-center gap-4">
                <div
                  ...
                  style={{ backgroundColor: `${COLORS.maityPink}20` }}
                >
