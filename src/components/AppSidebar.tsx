...
export function AppSidebar() {
  ...
  console.log('[AppSidebar] userRole:', userRole, 'isAdmin:', isAdmin);
              ...
              <SidebarMenu className="space-y-1 px-2">
                <SidebarMenuItem>
                  <SidebarMenuButton
                    ...
                    `}
                  >
                    <Link to="/demo" className={`flex items-center ${state === "collapsed" ? '' : 'gap-3'}`}>
                      <Play className={`h-5 w-5 ${isActive("/demo") ? 'text-white' : ''}`} />
                      {state !== "collapsed" && (
                        <span className="font-medium transition-colors">Demo</span>
                      )}
                    </Link>
                  </SidebarMenuButton>
                </SidebarMenuItem>
